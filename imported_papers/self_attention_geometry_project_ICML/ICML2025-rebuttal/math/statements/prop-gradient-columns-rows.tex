...
%
%
Let $U = \{t_1, \dots, t_N\}$ be a sequence of tokens and let $\bm{x}_i \in \mathbb{R}^d$ be the embedding of the $i$-th token. 
%
...
%
\begin{equation}
    \Delta \bm{w}_{\cdot, k} \bigg|_{t_j = t^*}= [\bm{x}_{t^*}]_k \left(\sum_{i \in \mathcal{P}_{t^*}}\beta_{i*}\bm{x}_i\right)\,,
\end{equation}
%
...
%
\begin{equation}
    \Delta \bm{w}_{m, \cdot} \bigg|_{t_i = t^*} = [\bm{x}_{t^*}]_m \left(\sum_{j \in \mathcal{C}_{t^*}}\beta_{*j}\bm{x}_j^\top\right)\,.
\end{equation}
%
